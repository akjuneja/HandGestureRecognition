...
from src.learning_models.neural_network_model.rl_network import CNN1DEncoder, RelationNetwork
...
from src.utils.neural_network_related.task_generator import HandGestureTask, get_data_loader
            ...
            if (episode + 1) % 20 == 0:
                ...
                if test_accuracy > last_accuracy:
                    ...
                    torch.save(self.feature_encoder.state_dict(),
                               str("./src/saved_models/hand_feature_encoder_" + str(self.num_classes) + "way_" + str(
                                   self.sample_num_per_class) + "shot.pkl"))
                    torch.save(self.relation_network.state_dict(),
                               str("./src/saved_models/hand_relation_network_" + str(self.num_classes) + "way_" + str(
                                   self.sample_num_per_class) + "shot.pkl"))
