...
from src.learning_models.neural_network_model.prototypical_network import CNN1DEncoder
...
class train_proto_model:
    ...
    def _load_data(self, train = True):
        training_data_path = './HandDataset/train_sim'
        testing_data_path = './HandDataset/eval'
        data_path = ""
